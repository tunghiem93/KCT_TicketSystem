...
namespace TicketDesk.Domain.Model
{
    ...
    public class UserTicketDateRangeFilterColumn
    {
        public UserTicketDateRangeFilterColumn()
        {            
        }

        public UserTicketDateRangeFilterColumn(DateTime toDate, DateTime fromDate)
        {
            ToDate = toDate;
            FromDate = fromDate;
        }
