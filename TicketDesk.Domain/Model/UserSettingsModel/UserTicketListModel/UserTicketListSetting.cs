...
namespace TicketDesk.Domain.Model
{
    ...
    public class UserTicketListSetting
    {
        ...
        /// <summary>
        ///   Get or sets the filter column
        /// </summary>
        public ICollection<UserTicketDateRangeFilterColumn> FilterDateRangeColumns { get; set; }
        ...
        internal static List<UserTicketListSetting> GetDefaultListSettings(string userId, bool isHelpDeskUserOrAdmin)
        {
            ...
            var disableProjectColumn = new List<string> { "ProjectId" };//add settting Project
            ...
            var disableToDateColumn  = new List<string> { "ToDate" };
            var disableFromDateColumn = new List<string> { "FromDate" };
            ...
            if (isHelpDeskUserOrAdmin)
            {
                ...
                unassignedFilterColumns.Add(new UserTicketListFilterColumn("ProjectId", null, null, typeof(int)));//add setting project
                ...
                unassignedFilterColumns.Add(new UserTicketListFilterColumn("ToDate", true, DateTime.Now.ToString("MM/dd/yyyy"), typeof(string)));
                unassignedFilterColumns.Add(new UserTicketListFilterColumn("FromDate", true, DateTime.Now.ToString("MM/dd/yyyy"), typeof(string)));
                ...
                assignedToMeFilterColumns.Add(new UserTicketListFilterColumn("ProjectId", null, null, typeof(int)));//add setting project
                ...
                assignedToMeFilterColumns.Add(new UserTicketListFilterColumn("ToDate", true, DateTime.Now.ToString("MM/dd/yyyy"), typeof(string)));
                assignedToMeFilterColumns.Add(new UserTicketListFilterColumn("FromDate", true, DateTime.Now.ToString("MM/dd/yyyy"), typeof(string)));
            ...
            myFilterColumns.Add(new UserTicketListFilterColumn("ProjectId", null, null, typeof(int)));//add setting project
            ...
            myFilterColumns.Add(new UserTicketListFilterColumn("ToDate", true, DateTime.Now.ToString("MM/dd/yyyy"), typeof(string)));
            myFilterColumns.Add(new UserTicketListFilterColumn("FromDate", true, DateTime.Now.ToString("MM/dd/yyyy"), typeof(string)));
            ...
            openFilterColumns.Add(new UserTicketListFilterColumn("ProjectId", null, null, typeof(int)));//add setting project
            openFilterColumns.Add(new UserTicketListFilterColumn("TicketStatus", false, TicketStatus.Closed));
            openFilterColumns.Add(new UserTicketListFilterColumn("ToDate", true, DateTime.Now.ToString("MM/dd/yyyy"), typeof(string)));
            openFilterColumns.Add(new UserTicketListFilterColumn("FromDate", true, DateTime.Now.ToString("MM/dd/yyyy"), typeof(string)));
            ...
            historyticketsFilterColumns.Add(new UserTicketListFilterColumn("ProjectId", null, null, typeof(int)));//add setting project
            historyticketsFilterColumns.Add(new UserTicketListFilterColumn("TicketStatus", true, TicketStatus.Closed));
            historyticketsFilterColumns.Add(new UserTicketListFilterColumn("ToDate", true, DateTime.Now.ToString("MM/dd/yyyy"), typeof(string)));
            historyticketsFilterColumns.Add(new UserTicketListFilterColumn("FromDate", true, DateTime.Now.ToString("MM/dd/yyyy"), typeof(string)));
